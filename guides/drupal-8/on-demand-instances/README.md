...
| Environment    | URL                                                                                                                        |
| -------------- | -------------------------------------------------------------------------------------------------------------------------- |
| uat            | <p><a href="https://d8-uat.boston.gov">https://d8-uat.boston.gov</a></p><p>(public DNS entry)</p>                          |
| ci             | <p><a href="https://d8-ci.boston.gov">https://d8-ci.boston.gov</a></p><p>(public DNS entry)</p>                            |
| dev2           | <p><a href="https://d8-dev2.boston.gov">https://d8-dev2.boston.gov</a></p><p>(no DNS - make entry in local hosts file)</p> |
| dev3 (pending) | <p>https://d8-dev3.boston.gov</p><p>(no DNS - make entry in local hosts file)</p>                                          |
