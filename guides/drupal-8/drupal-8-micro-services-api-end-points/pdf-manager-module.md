...
The CLI package [PDFToolkit (pdftk)](https://www.pdflabs.com/docs/pdftk-man-page) was leveraged and [a City of Boston managed API](../../amazon-web-services/services/microservices-2021/pdf-manager.md) was deployed in AWS as a microservice to create and edit fillable PDF's (fillable forms).&#x20;
