...
{% api-method method="get" host="https://dbconnector.digital-staging.boston.gov" path="/users/:userid" %}
{% api-method-summary %}
List a single User
{% endapi-method-summary %}
...
{% api-method method="patch" host="https://dbconnector.digital-staging.boston.gov" path="/users/:userid" %}
{% api-method-summary %}
...
| :--- | :--- | :--- |
| NORMAL USER | 1 | Can authenticate and then use the **/query** endpoint |
| SUPER USER | 4 | Can authenticate and then use the **/query** and  **/select** endpoints |
| ADMIN | 2048 | Can use all endpoints |
